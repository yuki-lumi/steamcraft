...
public class SteamCraft {
    ...
    public SteamCraft(IEventBus modEventBus, ModContainer modContainer) {
    ...
    @EventBusSubscriber(modid = SteamCraft.MODID, bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
